...
<html>
    <head>
		...
		<link rel="stylesheet" href="https://veronicatomilola.github.io/veronica/Veronica.css" />
	...
	<body>
		<div id="head">
			<div id="name">
				...
				<a id="image" href=" https://res.cloudinary.com/vtomilola/image/upload/v1566942482/samples/IMG_20190814_112259_ubl3ra.jpg"> 
					<img src="avar.jpg" style="width:50px"/>
				</a>
			</div>
		
			<div id="contact">
				<div id="address">
			  		<p>	Address: No 7, Sharafadeen Soyege Close, Off Oluwole Akinoso Street, Magodo Phase 2, Lagos State, Nigeria. </p>
				</div>
				<div id="email">
		...
		<div id="body">
			...
			<button id="btn_contact" type="button"><a href="contact-form.php"></button>> Contact Me </button>
