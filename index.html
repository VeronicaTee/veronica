...
?>
	...
	<div id="body">
		...
		<div id="contact_me" >
			<form id="contact_form " name="formName" class="contact animate" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" onsubmit="return verification()" 
			...
			<div class="container">
				...
				<label> Name </label> <br>
				<input name="Name" id="YourName" class="view-input" type="text" min="4"  placeholder="Your name.." required /> <br>
				
				<label> Your Email </label> <br>				
				<input name="mail" id="YourMail" class="view-input" type="email" placeholder="Your email.." required /> <br>
				
				<label> Phone Number (Optional) </label> <br>				
				<input name="phone" id="YourPhone" class="view-input" type="text"  placeholder="Your phone number .."  size="1"> <br>
				
				<label> Title </label> <br>				
				<input name="title" class="view-input" type="text" min="12" placeholder="Message Title .." required /> <br>
				
				<label> Message </label> <br>
				<textarea name="message" id="YourMessage" class="view-input" type="text"  placeholder="Your message.." required
					rows="6" cols="30"> 
				</textarea>
				</div>
			</div>
			<span id="msgText" style="margin-left:50px"> </span>
